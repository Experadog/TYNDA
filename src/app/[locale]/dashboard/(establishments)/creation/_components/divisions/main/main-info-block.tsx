...
import { CustomFormField, Form } from '@components';
		...
		<div className="flex flex-col gap-7">
			<div className="flex gap-10">
				<Form {...schema}>
					<form
						className="w-full"
						onSubmit={schema.handleSubmit((values) => console.log(values))}
					>
						<div className="flex flex-col gap-5 w-full">
							...
							{ItemBlock(
								<div className="flex items-start gap-3 w-full">
									<CustomSelect
										data={Object.values(ESTABLISHMENTS_CATEGORIES).map(
											(value) => ({

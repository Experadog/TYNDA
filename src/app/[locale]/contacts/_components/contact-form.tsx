    ...
    return (
        <div className='my-[100px] lg:my-[60px] flex flex-col gap-[60px]'>
            <div className='flex lg:flex-wrap items-center gap-8'>
                <h3 className='text-4xl lg:text-2xl font-medium'>Свяжитесь с нами – мы всегда готовы помочь и ответить на ваши вопросы!</h3>
                <p className='opacity-70 text-base font-normal max-w-[357px]'>Вы можете задать вопросы, уточнить детали маршрутов и оформить бронирование удобным способом.</p>
            </div>

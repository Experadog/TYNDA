...
const photosData = ['/enterprisesBg.webp', '/enterprisesBg.webp', '/enterprisesBg.webp', '/enterprisesBg.webp', '/enterprisesBg.webp'];
    ...
    return (
        <div className='mt-[80px] lg:mt-[30px] flex flex-col gap-7 mb-[100px]'>
            ...
            <div className='flex items-center justify-center max-w-[353px]'>
                <Button className='rounded-2xl hidden lg:block h-14 bg-yellow text-white text-base font-semibold w-full'>Показать все фото</Button>
            </div>

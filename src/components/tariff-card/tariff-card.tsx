...
const TariffCard: FC<IProps> = ({ isActive }) => {
    ...
    const backgroundImage = isActive ? '/profile/active-tariff.webp' : '/profile/non-active-tariff.webp';
        ...
        >
            <div className='card-content flex flex-col p-4 w-full h-full justify-between'>
                ...
                <div className='flex items-center justify-between'>
                    <span className='text-white uppercase font-semibold text-lg'>Touristic plan</span>
                    <span className='text-white uppercase font-extrabold text-xl numeric'>05/08</span>
                </div>
            </div>
            <div
